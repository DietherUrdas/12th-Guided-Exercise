...
public class AverageResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvAverageResult = findViewById(R.id.tvAverageResult);
        double average = getIntent().getDoubleExtra("average", 0);
        tvAverageResult.setText("Average: " + average);

        findViewById(R.id.btnBackToCompute).setOnClickListener(v -> finish());
    }
}